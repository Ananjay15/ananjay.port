  ...
  return (
    <section id="about" className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h3 className="text-2xl font-semibold mb-6">Passionate About Creating Amazing Web Experiences</h3>
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <div className="text-center p-4 bg-gray-900/50 rounded-lg border border-gray-800 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-4">
            <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800 transform hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              <AnimatedWebSVG />
              <h4 className="font-semibold mb-2">Web Development</h4>
              <p className="text-sm text-gray-400">Modern, responsive websites</p>
            </div>
            <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800 transform hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              <AnimatedMobileSVG />
          ...
          <div className="space-y-4 mt-8">
            <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800 transform hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              <div className="mx-auto mb-4 w-fit"><Code size={32} className="text-green-400 animate-pulse" /></div>
            ...
            <div className="p-6 bg-gray-900/50 rounded-xl border border-gray-800 transform hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              ...
              <p className="text-sm text-gray-400">Beautiful interfaces</p>
            </div>
          </div>
        </div>
      </div>
